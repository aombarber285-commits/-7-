...
code = '''import time, json, os, urllib.request
...
def run():
    ...
    else:print("⚠️ DISCORD_WEBHOOK_URL is not set.",flush=True)
    if not GEMINI_API_KEY:print("⛔ GEMINI_API_KEY missing: AI-approved signals are disabled.",flush=True)
...
path=Path("/mnt/data/SIGZY_BRAIN_V6_0_3BRAIN.py")
